...
class TestFilterByEmployeeId(unittest.TestCase):
    # Test Case ID: TC05
    def setUp(self):
    ...
    def test_filter_by_employee_id (self):
        ...
        PageObject.inputByXpath(self, "//*[@id='app']/div[1]/div[2]/div[2]/div/div[1]/div[2]/form/div[1]/div/div[2]/div/div[2]/input", "0054")
        PageObject.clickByXpath(self, "//*[@id='app']/div[1]/div[2]/div[2]/div/div[1]/div[2]/form/div[2]/button[2]")
        
        # Validation 
        title = driver.find_element(By.XPATH, "//*[@id='app']/div[1]/div[2]/div[2]/div/div[2]/div[3]/div/div[2]/div/div/div[2]")
        print(title)
        self.assertIn('0054', title)
